...
# 25.02.2026
# add SSH authentication (key/password) 

# 26.02.2026
# implement connection testing and error handling 

# 27.02.2026
# create folder "transfer_test" in ~/projects/FWH-SecureSync/paramiko/transfer_test
...
# implement logging system (~/projects/FWH-SecureSync/transfer.log)